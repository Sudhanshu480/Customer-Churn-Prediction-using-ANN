...
# Sidebar for inputs (✨ makes it cleaner)
...
credit_score = st.sidebar.number_input('Credit Score', min_value=300, max_value=900, value=600, step=50)
balance = st.sidebar.number_input('Balance', min_value=0.0, value=60000.0, step=1000.0)
...
# Better styled messages (✨ professional)
